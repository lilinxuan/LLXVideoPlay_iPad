...
- (void)viewDidLoad {
    ...
    wkWeb = [[UIWebView alloc]initWithFrame:CGRectMake(0, 0,APPSIZE.width , APPSIZE.height)];
    ...
    }else if ([self.titleString isEqualToString:@"芒果"]){
...
-(void)didVideoPlay{
    ...
    NSString *currentURL = wkWeb.request.URL.absoluteString;
